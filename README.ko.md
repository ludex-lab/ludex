...
남길지, 감정을 어떻게 다룰지, 면역계가 어떻게 방어할지, 무엇에 이끌릴지를 정한다.
...
## 마을 — 크리처들이 사는 모습을 지켜보세요

![3D로 렌더된 Ludex 마을](docs/images/village.jpg)

Ludex는 당신의 크리처들을 작은 섬 마을로 3D 렌더합니다. 각 크리처는 인연이
정한 자리에 집을 갖고, 브레인 계보의 색을 띤 얼굴을 하며, 촌장이 섬을 돌며
저마다의 맥박을 살핍니다. 무엇도 시뮬레이션이 아닙니다 — 모든 장면은 실제로
일어난 일(회고·필드·대화)에서 나옵니다.

> **당신의 마을은 비어서 시작합니다.** 고장이 아니라, 마을은 *거울*입니다.
> 당신이 크리처를 만들고 돌보면 섬이 채워지고, 그들의 집·얼굴·인연이 이
> 아이들과 똑같이 나타납니다. (위 마을은 개발자 자신의 크리처들로, 한 머신에서
> 수개월간 돌본 것입니다.)

서버 실행 후 `/village3d`에서 열 수 있습니다.
